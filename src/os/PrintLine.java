...
public class PrintLine extends Process {
	...
	public PrintLine(int intID, String extID, int parentProcess, int priority, String startState) {
	...
	public void run() {
		...
		if ((phase == 3) && (receivedResource == 5) && (pState.equals("ru"))) {
			...
			PyOS.freeResource(PyOS.waitingList5, 5, ownedResList.get(ownedResList.size()-1));
			phase = 4;	
		}
